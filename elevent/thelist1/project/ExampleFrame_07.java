...
public class ExampleFrame_07 extends JFrame {
	...
	public ExampleFrame_07() {
		...
		newItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_N,
				InputEvent.CTRL_MASK));// 设置加速器为“Ctrl+N”
		...
		bCheckBoxItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_B,
				InputEvent.CTRL_MASK | InputEvent.ALT_MASK)); // 设置加速器为“Ctrl+Alt+B”
		...
		iCheckBoxItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_I,
				InputEvent.CTRL_MASK | InputEvent.ALT_MASK)); // 设置加速器为“Ctrl+Alt+I”
		...
		rRadioButtonItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_R,
				InputEvent.CTRL_MASK | InputEvent.ALT_MASK));// 设置加速器为“Ctrl+Alt+R”
		...
		eRadioButtonItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_E,
				InputEvent.CTRL_MASK | InputEvent.ALT_MASK));// 设置加速器为“Ctrl+Alt+E”
