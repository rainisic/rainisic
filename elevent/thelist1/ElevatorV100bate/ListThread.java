...
public class ListThread extends JPanel implements Runnable,Publiclist
{
	...
	private int listNum; //电梯编号
	private int listPeople,listMaxPeople=10; //电梯人数，电梯最大人数
	...
	public void listNumPressed(int i)
	{
		numState[i] = true;
		numButton[i].setBackground(numColor1);
		setlistButtonCalOn(i);
		if (direction == ABORT)
		{
			tarPos = i;
		}
	...
	public void setDirectionUp()  //设置电梯方向
	{
		direction = UP;
	}
	...
	public void ListPeapleleave()
	{
		if(listPeople<0)
			listPeople=1;
		if(listPeople>0){
		listAi.getListAiData(this.curPos);
		if(listAi.getListAiData(curPos).AiBornPos != 0)
			listAi.getListAiData(curPos);
		listPeople--;
		}
		
	}
	public void setListPeaple()
	{
		if(listPeople<0)
			listPeople=1;
	}

	public void setFloorlock(int i)    //设置电梯锁
	{
		floorlock[i] = true;
	...
	public void setSpfloor(int i)   //设置特殊电梯楼层
	{
		spfloor = i;
	}
	...
	public void setspfloorOff(int i)    //设置特殊电梯楼层开关
	{
		if(i == 1)
		spflooroff = true;
		else{
	...
	public void setlistPeople(int i)    //设置电梯人数
	{
		listPeople = i;
	}
	
	public int listPeople()
	{
		return listPeople;
	}
	
	public void setlistButtonCalOn(int i)    //设置电梯按钮响应统计开启
	{
		listText.listButtonData[i][listNum][1] = 1 ;
	}
	public void setlistButtonCalOff(int i)    //设置电梯按钮响应统计
	{
		listText.listButtonData[i][listNum][1] = 0 ;
	}
